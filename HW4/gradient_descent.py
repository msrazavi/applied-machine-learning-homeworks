...
def setup_functions():
    #Uses SymPy to define the function symbolically, calculate the exact derivative, and convert them to standard Python functions.
...
def grad_f(x, y):
    #Computes the gradient using the exact symbolic derivatives generated by SymPy.
...
def gradient_descent(start_x, start_y, learning_rate, n_iterations=20):
    #Performs gradient descent optimization. Returns a history of points (path).
    # Initialize point
    x, y = start_x, start_y
    path = [(x, y)]
